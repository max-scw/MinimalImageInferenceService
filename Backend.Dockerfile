...
COPY Backend/main.py Backend/default_config.toml Backend/utils_communication.py Backend/utils_data_models.py Backend/plot_pil.py Backend/check_boxes.py Backend/helper_functions.py ./
